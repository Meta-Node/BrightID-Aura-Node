...
MAX_PENDING_SNAPSHOTS = int(os.environ.get("BN_CONSENSUS_MAX_PENDING_SNAPSHOTS", 3))
if MAX_PENDING_SNAPSHOTS <= 0:
    raise ValueError(
        f"BN_CONSENSUS_MAX_PENDING_SNAPSHOTS must be positive, got {MAX_PENDING_SNAPSHOTS}"
    )
